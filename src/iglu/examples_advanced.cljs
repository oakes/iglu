...
(defexample iglu.examples-advanced/crescent-3d
  {:with-card card}
  (->> (iglu.examples/create-canvas card)
       (iglu.examples-advanced/crescent-3d-init)))
...
(defexample iglu.examples-advanced/torus-3d
  {:with-card card}
  (->> (iglu.examples/create-canvas card)
       (iglu.examples-advanced/torus-3d-init)))
...
(defexample iglu.examples-advanced/disc-3d
  {:with-card card}
  (->> (iglu.examples/create-canvas card)
       (iglu.examples-advanced/disc-3d-init)))
